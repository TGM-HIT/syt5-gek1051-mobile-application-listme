...
|12|Als Benutzer möchte ich Teilnehmer aus einer geteilten Liste entfernen können, um die Zugriffskontrolle zu wahren.|5|Schl|SH|-|
...
|14|Als Benutzer möchte ich Preise zu Artikeln speichern und die geschätzten Gesamtkosten pro Liste sehen, damit ich mein Budget im Blick behalte.|3|Schl|SH|-|
|15|Als Benutzer möchte ich Dark Mode / helles Design umschalten können, damit die App für mich angenehmer zu bedienen ist.|3|Schl|SH|-|
...
|19|Als Benutzer möchte ich Artikel per Spracheingabe hinzufügen können, damit ich schneller einkaufen kann.|3|Schl|N2H|-|
...
|23|Als Benutzer möchte ich gelöschte Listen im Papierkorb wiederherstellen können, damit versehentliche Löschungen rückgängig gemacht werden.|3|Schl|N2H|-|
...
| Laurin Schieder (**Developer-A Schl**) | 24 |
